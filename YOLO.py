...
class Yolo:
    def __init__(self):
        # paths
        self.root = 'C:/Users/lenovo/Desktop/study/Pythonhigh/kivy/kivy_venv/my/'
    ...
    def run(self,image):
            ...
            <style>
                ...
                *{
                ...
                #main-wrapper{
                    ...
                    width: 1700px;
                    height: 2000px;
                    background-image: url('./picture/tamplet.jpg');
        """
        html_code.replace('\n',' ')
        html2 = """ 
        ...
        # create html
        with open(self.root + 'test.html','w',encoding='UTF-8') as f :
            f.write(html_code)
            f.close()

        # open html 
        url = self.root + 'test.html' # in url no hangul
